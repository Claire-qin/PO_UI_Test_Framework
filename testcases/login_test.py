...
class LoginTest(SeleniumBaseCase):
    ...
    test_class_date = TestDataUtil('login_suite', 'LoginTest').convert_exceldata_to_testdata()  # 重载  类属性
    def setUp(self) -> None:
        super().setUp()

    def test_login_success(self):
        test_function_data = self.test_class_date['test_login_success']
        self._testMethodDoc = test_function_data['test_name']   # 说明
    ...
    @unittest.skipIf(test_class_date['test_login_fail']['isnot'],'')
